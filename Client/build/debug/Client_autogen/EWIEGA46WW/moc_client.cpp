...
void Client::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (Client::*)(QString )>(_a, &Client::sendMessage, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (Client::*)(QString , int )>(_a, &Client::logMessage, 1))
            return;
    }
}
...
// SIGNAL 0
void Client::sendMessage(QString _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 0, nullptr, _t1);
}

// SIGNAL 1
void Client::logMessage(QString _t1, int _t2)
{
