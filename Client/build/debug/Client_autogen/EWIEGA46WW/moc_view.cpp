...
template <> constexpr inline auto View::qt_create_metaobjectdata<qt_meta_tag_ZN4ViewE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Signal 'logMessage'
        QtMocHelpers::SignalData<void(QString, int)>(7, 2, QMC::AccessPublic, QMetaType::Void, {{
...
void View::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (View::*)(QString , quint16 )>(_a, &View::connectToServer, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (View::*)()>(_a, &View::disconnectFromServer, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (View::*)()>(_a, &View::clientStatus, 2))
            return;
        if (QtMocHelpers::indexOfMethod<void (View::*)(QString , int )>(_a, &View::logMessage, 3))
            return;
...
// SIGNAL 0
void View::connectToServer(QString _t1, quint16 _t2)
{
...
// SIGNAL 3
void View::logMessage(QString _t1, int _t2)
{
