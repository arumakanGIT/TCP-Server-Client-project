...
template <> constexpr inline auto NetworkManager::qt_create_metaobjectdata<qt_meta_tag_ZN14NetworkManagerE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'createServer'
        QtMocHelpers::SlotData<void(QString, quint16)>(5, 2, QMC::AccessPublic, QMetaType::Void, {{
        ...
        // Slot 'turnOnServer'
        QtMocHelpers::SlotData<void(QString, QString, quint16)>(11, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::QString, 12 }, { QMetaType::QString, 6 }, { QMetaType::UShort, 7 },
        }}),
    };
...
void NetworkManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->createServer((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<quint16>>(_a[2]))); break;
        case 2: _t->serversStatus(); break;
        case 3: _t->turnOffServer((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1]))); break;
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (NetworkManager::*)(QString , int )>(_a, &NetworkManager::logMessage, 0))
            return;
    }
}
...
// SIGNAL 0
void NetworkManager::logMessage(QString _t1, int _t2)
{
